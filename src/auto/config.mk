...
LDFLAGS		= -L. -Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now -fstack-protector -rdynamic -Wl,-export-dynamic -Wl,-E   -L/usr/local/lib -Wl,--as-needed
...
PERL_LIBS	= -Wl,-E  -fstack-protector-strong -L/usr/local/lib  -L/usr/lib/x86_64-linux-gnu/perl/5.22/CORE -lperl -ldl -lm -lpthread -lcrypt
SHRPENV		= 
PERL_SRC	= auto/if_perl.c if_perlsfio.c
PERL_OBJ	= objects/if_perl.o objects/if_perlsfio.o
PERL_PRO	= if_perl.pro if_perlsfio.pro
PERL_CFLAGS	=  -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv  -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -I/usr/lib/x86_64-linux-gnu/perl/5.22/CORE 

PYTHON_SRC	= if_python.c
PYTHON_OBJ	= objects/if_python.o
PYTHON_CFLAGS	= -I/usr/include/python2.7 -DPYTHON_HOME='"/usr"' -pthread -DDYNAMIC_PYTHON_DLL=\"\"
PYTHON_LIBS	= 
...
PYTHON3_CFLAGS	= -I/usr/include/python3.5m -DPYTHON3_HOME='L"/usr"' -pthread -DDYNAMIC_PYTHON3_DLL=\"\"
PYTHON3_LIBS	= 
PYTHON3_CONFDIR	= /usr/lib/python3.5/config
...
RUBY_CFLAGS	= -I/usr/include/ruby-2.3.0 -DRUBY_VERSION=23
